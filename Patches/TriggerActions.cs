...
internal class TriggerActions
    ...
    /*
     * Syntax: Aviroen.RandomDialogue <ModID> <NPC> <i18ntokenbase> <suffix_options>
     * e.g. Aviroen.RandomDialogue author.testmod Maru test. {{Range:1,5}},OtherKey
     */
    public static bool Yapper(string[] args, TriggerActionContext context, out string? error)
    {
        if (args.Length < 5)
        {
        ...
        //SB.ModMonitor.Log(dialogue, LogLevel.Alert);
